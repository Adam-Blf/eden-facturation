...
export default async function ComptaPage() {
  ...
  const inputCls = "rounded-lg border border-hair bg-void px-3 py-2 text-sm outline-none focus:border-brass";
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-hair bg-paper p-5">
          ...
          <form action={addPayment} className="mb-4 flex flex-wrap gap-2">
            ...
            <button className="rounded-full bg-brass px-4 py-2 text-sm font-bold text-void hover:bg-tan">Ajouter</button>
          </form>
