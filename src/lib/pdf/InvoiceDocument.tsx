...
function makeStyles(st: BusinessSettings) {
  ...
  return StyleSheet.create({
    ...
    metaValue: { fontFamily: "IBM Plex Mono", fontSize: 8.5, color: ink },
    ...
    linePrice: { fontFamily: "IBM Plex Mono", fontSize: 10, color: primary },
